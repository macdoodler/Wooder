// Debug script for the quantity issue using Jest environment
// Run with: npm test -- debug-quantity-issue.js

// Mock window for Node.js environment
global.window = { DEBUG_CUTTING: true };

console.log('🔍 Debugging Quantity Issue\n');

// Test case: 2 parts requested should result in exactly 2 parts placed
console.log('=== Test: 2 Parts Requested ===');
const stocks = [
  {
    length: 2400,
    width: 1200,
